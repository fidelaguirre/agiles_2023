...
import { getEvento, listBandas } from "../graphql/queries";
...
export default function EventoUpdateForm(props) {
  const {
    id: idProp,
    evento: eventoModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = eventoRecord
      ? { ...initialValues, ...eventoRecord, Banda }
      : initialValues;
    setName(cleanValues.name);
    setDate(cleanValues.date);
    setLocation(cleanValues.location);
    setDescription(cleanValues.description);
    setBanda(cleanValues.Banda);
    setCurrentBandaValue(undefined);
    setCurrentBandaDisplayValue("");
    setErrors({});
  };
  const [eventoRecord, setEventoRecord] = React.useState(eventoModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ...
        : eventoModelProp;
      const BandaRecord = record ? await record.Banda : undefined;
      setBanda(BandaRecord);
      setEventoRecord(record);
    };
    queryData();
  }, [idProp, eventoModelProp]);
  React.useEffect(resetStateValues, [eventoRecord, Banda]);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "EventoUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || eventoModelProp)}
