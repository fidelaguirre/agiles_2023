...
import { createIntegrante } from "../graphql/mutations";
export default function IntegranteCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setId_perfil(initialValues.id_perfil);
    setId_banda(initialValues.id_banda);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "IntegranteCreateForm")}
      {...rest}
    >
      <TextField
        label="Id perfil"
